...
window.ACROVAULT_TOOLS = [
    ...
    { id: "mapping-police-violence", name: "Mapping Police Violence", desc: "Patterns in police violence data", url: "https://mappingpoliceviolence.org/", category: "crime-evidence", categoryName: "Crime & Evidence Databases", icon: "⚖️", tags: ["police", "violence", "mapping"], isPremium: false },
    { id: "cityprotect", name: "CityProtect", desc: "Map local crime using reliable data", url: "https://cityprotect.com/", category: "crime-evidence", categoryName: "Crime & Evidence Databases", icon: "⚖️", tags: ["local", "crime", "map"], isPremium: false },
    { id: "panama-papers", name: "Panama Papers (ICIJ)", desc: "Offshore entities linked to scandals", url: "https://panamapapers.icij.org/", category: "crime-evidence", categoryName: "Crime & Evidence Databases", icon: "⚖️", tags: ["offshore", "leaks", "scandals"], isPremium: false },
    ...
    { id: "killer-cloud", name: "Killer.Cloud", desc: "Database of different homicide cases", url: "http://Killer.Cloud", category: "crime-evidence", categoryName: "Crime & Evidence Databases", icon: "⚖️", tags: ["homicide", "database", "cases"], isPremium: false },
    ...
    { id: "uncovered", name: "Uncovered", desc: "Explore cold cases with evidence timelines", url: "https://www.uncovered.com/", category: "crime-evidence", categoryName: "Crime & Evidence Databases", icon: "⚖️", tags: ["cold cases", "evidence", "timeline"], isPremium: false },
    ...
    { id: "openmhz", name: "OpenMHz", desc: "Listen to archived police radio traffic", url: "https://www.openmhz.com/", category: "crime-evidence", categoryName: "Crime & Evidence Databases", icon: "⚖️", tags: ["police", "radio", "archive"], isPremium: false },
    ...
    { id: "copblock", name: "CopBlock", desc: "Browse reports of police misconduct incidents", url: "https://copblock.org/", category: "crime-evidence", categoryName: "Crime & Evidence Databases", icon: "⚖️", tags: ["police", "misconduct", "reports"], isPremium: false },
    ...
    { id: "the-unredacted", name: "The Unredacted", desc: "Declassified intelligence and documents archive", url: "https://theunredacted.com/", category: "crime-evidence", categoryName: "Crime & Evidence Databases", icon: "⚖️", tags: ["declassified", "intelligence", "archive"], isPremium: false },
    { id: "documentcloud", name: "DocumentCloud Documents", desc: "Investigative data used in journalism", url: "https://www.documentcloud.org/documents/", category: "crime-evidence", categoryName: "Crime & Evidence Databases", icon: "⚖️", tags: ["documents", "investigation", "journalism"], isPremium: false },
    { id: "crime-scene-investigator-edu", name: "Crime Scene Investigator EDU", desc: "Learn evidence collection and analysis", url: "https://www.crimesceneinvestigatoredu.org/", category: "crime-evidence", categoryName: "Crime & Evidence Databases", icon: "⚖️", tags: ["education", "investigation", "evidence"], isPremium: false },

    // Category: Advanced OSINT Tools
    { id: "tookie-osint", name: "tookie-osint", desc: "Advanced OSINT info-gathering, finds social media accounts", url: "https://github.com/Alfredredbird/tookie-osint", category: "osint", categoryName: "Advanced OSINT Tools", icon: "🕵️", tags: ["osint", "social media", "recon"], isPremium: false },
    ...
    { id: "ironsight", name: "IRONSIGHT", desc: "Real-time OSINT command center for Middle East conflict", url: "https://github.com/NoblerWorks-HQ/IRONSIGHT", category: "osint", categoryName: "Advanced OSINT Tools", icon: "🕵️", tags: ["osint", "real-time", "command center"], isPremium: false },
    { id: "robin", name: "Robin", desc: "AI-powered dark web OSINT investigation tool", url: "https://github.com/apurvsinghgautam/robin", category: "osint", categoryName: "Advanced OSINT Tools", icon: "🕵️", tags: ["ai", "dark web", "osint"], isPremium: false },
    ...
    { id: "cybersecurity-framework", name: "Cybersecurity Competency Framework", desc: "Research-driven roadmap for deep cybersecurity mastery", url: "https://github.com/vivek-threatintel/cybersecurity-competency-framework", category: "roadmap", categoryName: "Cybersecurity Roadmap & Resources", icon: "🗺️", tags: ["roadmap", "framework", "learning"], isPremium: false },
    { id: "comptia-security-notes", name: "CompTIA Security+ Study Notes", desc: "Concise Security+ resources covering core fundamentals", url: "https://drive.google.com/drive/folders/106Oo8yist33rLkFaDxgxkUk9HcRPvacW", category: "roadmap", categoryName: "Cybersecurity Roadmap & Resources", icon: "🗺️", tags: ["comptia", "security+", "notes"], isPremium: false },

    // Category: Hardware Hacking
    { id: "esp32-bit-pirate", name: "ESP32 Bit Pirate", desc: "Open-source multi-protocol hacking firmware for I2C/UART/SPI/Wi-Fi/Bluetooth/RFID", url: "https://github.com/geo-tp/ESP32-Bit-Pirate", category: "hardware-hacking", categoryName: "Hardware Hacking", icon: "🔌", tags: ["hardware", "esp32", "firmware"], isPremium: false },

    // Category: AI Vision-Language Models
    { id: "eagle-frontier-vlm", name: "Eagle: Frontier VLM", desc: "NVIDIA research for frontier vision-language models", url: "https://github.com/NVlabs/Eagle", category: "ai-research", categoryName: "AI Vision-Language Models", icon: "🧠", tags: ["ai", "vlm", "nvidia"], isPremium: false },

    // Category: VAPT Tools
    { id: "acrostrike-v2", name: "AcroStrike v2.0", desc: "PowerShell-based 20-phase VAPT scanner with OWASP Top 10 mapping", url: "https://github.com/acro777x/AcroStrike", category: "vapt", categoryName: "VAPT Tools", icon: "🛡️", tags: ["vapt", "scanner", "powershell"], isPremium: false },

    // Category: AI-Assisted Hacking
    { id: "mr7-ai", name: "mr7.ai", desc: "AI assistant for authorized security training & simulations", url: "https://hackeraicln-dxi92nff.manus.space/", category: "ai-hacking", categoryName: "AI-Assisted Hacking", icon: "🤖", tags: ["ai", "assistant", "training"], isPremium: false },

    // Category: Account Creation Tools
    { id: "gmail-account-creator", name: "gmail-account-creator", desc: "Creates Gmail accounts with anti-detection and phone verification bypass", url: "https://github.com/ShadowHackrs/gmail-account-creator", category: "account-tools", categoryName: "Account Creation Tools", icon: "👤", tags: ["gmail", "account", "creator"], isPremium: false },
    { id: "mailwave", name: "Mailwave", desc: "Free and fake edu mail generator", url: "https://mailwave.dev", category: "account-tools", categoryName: "Account Creation Tools", icon: "👤", tags: ["email", "edu", "generator"], isPremium: false },

    // Category: Agentic AI Attack + Report Generation
    { id: "vulnclaw", name: "VulnClaw", desc: "LLM Agent + MCP Toolchain automated recon to reporting", url: "https://github.com/Unclecheng-li/VulnClaw/blob/main/README_EN.md", category: "ai-attack", categoryName: "Agentic AI Attack + Report Generation", icon: "⚔️", tags: ["ai", "agent", "recon", "reporting"], isPremium: false },

    // Category: Malware Analysis
    { id: "hybrid-analysis", name: "Hybrid Analysis", desc: "Sandbox environment and malware analysis", url: "https://hybrid-analysis.com/", category: "malware-analysis", categoryName: "Malware Analysis", icon: "🦠", tags: ["malware", "sandbox", "analysis"], isPremium: false },
    { id: "virustotal", name: "VirusTotal", desc: "Malware type and name detection", url: "https://www.virustotal.com/gui/home/upload", category: "malware-analysis", categoryName: "Malware Analysis", icon: "🦠", tags: ["malware", "detection", "scanner"], isPremium: false },
    ...
    { id: "exploitarium", name: "Exploitarium", desc: "Archive of public exploit PoCs and vulnerability research", url: "https://github.com/bikini/exploitarium", category: "exploit-directory", categoryName: "Exploit Directory", icon: "💣", tags: ["exploit", "poc", "archive"], isPremium: false },
    { id: "cve2poc", name: "CVE2PoC", desc: "Find public exploits and PoCs by CVE ID", url: "https://github.com/0liverFlow/CVE2PoC", category: "exploit-directory", categoryName: "Exploit Directory", icon: "💣", tags: ["cve", "poc", "search"], isPremium: false },

    // Category: Malware Analysis Courses
    { id: "malware-analysis-uc", name: "Malware Analysis by University of Cincinnati", desc: "Basic to advanced malware analysis with assignments", url: "https://class.malware.re/", category: "malware-courses", categoryName: "Malware Analysis Courses", icon: "🎓", tags: ["course", "malware", "analysis"], isPremium: false },
    ...
    { id: "digital-forensics-guide", name: "Digital-Forensics-Guide", desc: "Complete guide: Computer, Mobile, Network, Database Forensics", url: "https://github.com/mikeroyal/Digital-Forensics-Guide", category: "digital-forensics", categoryName: "Digital Forensics", icon: "🔍", tags: ["guide", "forensics", "mobile", "network"], isPremium: false },
    { id: "dfir", name: "DFIR", desc: "List of free and open source forensics analysis tools", url: "https://github.com/mesquidar/ForensicsTools#imageing", category: "digital-forensics", categoryName: "Digital Forensics", icon: "🔍", tags: ["dfir", "tools", "list"], isPremium: false },
    ...
    { id: "rustscan", name: "RustScan", desc: "Modern port scanner, find ports in 3 seconds", url: "https://github.com/bee-san/RustScan", category: "port-scanners", categoryName: "Port Scanners", icon: "🚪", tags: ["scanner", "port", "network"], isPremium: false },

    // Category: Number Plate Detection
    { id: "fast-alpr", name: "Fast-ALPR", desc: "Fast Automatic License Plate Recognition framework", url: "https://github.com/ankandrew/fast-alpr", category: "detection-tools", categoryName: "Number Plate Detection", icon: "🚗", tags: ["alpr", "license plate", "recognition"], isPremium: false },

    // Category: API Gateway
    { id: "omniroute", name: "Omniroute", desc: "Free AI gateway: one endpoint, 160+ providers", url: "https://github.com/diegosouzapw/OmniRoute?tab=readme-ov-file", category: "api-gateway", categoryName: "API Gateway", icon: "🌉", tags: ["api", "gateway", "ai"], isPremium: false },

    // Category: Ethical Hacking Courses
    { id: "ethical-kali", name: "Ethical Kali", desc: "Kali Linux Networking, Pentesting, Web Security course", url: "https://mega.nz/folder/GzhlULjb#J2jHHd3_jc2SIOnQ4ouiDA", category: "ethical-hacking", categoryName: "Ethical Hacking Courses", icon: "📘", tags: ["kali", "networking", "course"], isPremium: false },
    ...
    { id: "deep-eye", name: "Deep-Eye", desc: "Multi-AI provider vulnerability scanner, 45+ vuln types, compliance reports", url: "https://github.com/zakirkun/deep-eye", category: "ai-vuln-scanner", categoryName: "AI Vulnerability Scanner", icon: "👁️", tags: ["ai", "scanner", "vulnerability"], isPremium: false },
    ...
    { id: "godmod", name: "Godmod", desc: "Uncensored + jailbroken AI chat via OpenRouter", url: "https://godmod3.ai/", category: "jailbreak-ai", categoryName: "Jailbreak AI", icon: "🔓", tags: ["jailbreak", "ai", "uncensored"], isPremium: false },

    // Category: API Key Scanning
    { id: "keyhunter", name: "KeyHunter", desc: "Fast Rust scanner for leaked API keys on GitHub", url: "https://github.com/fadidevv/keyhunter", category: "api-key-scanning", categoryName: "API Key Scanning", icon: "🔑", tags: ["scanner", "api keys", "rust"], isPremium: false },
    ...
    { id: "forensically", name: "Forensically", desc: "Browser-based toolkit for ELA, clone detection, metadata inspection", url: "https://29a.ch/photo-forensics/#error-level-analysi", category: "photo-forensics", categoryName: "Photo Forensics", icon: "📸", tags: ["toolkit", "metadata", "forensics"], isPremium: false },
